...
If ((Get-Module -ListAvailable -Name Microsoft.Graph))
{
	...
	Connect-MgGraph -ClientId 31b83a1a-79eb-46df-95c9-875d01349ebe -TenantId e22761ec-c265-4648-8db2-dfdc1afbfaf2 -CertificateThumbprint dc4955383984911916237588eebe88e330270005
	# Get M365 health
